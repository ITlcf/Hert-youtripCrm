...
// var cmbProvince = document.getElementsByName('cmbProvince')[0].value
// var cmbCity = document.getElementsByName('cmbCity')[0].value
// var cmbArea = document.getElementsByName('cmbArea')[0].value
// addressInit('cmbProvince', 'cmbCity', 'cmbArea')

 function addressInit(_cmbProvince, _cmbCity, _cmbArea, defaultProvince, defaultCity, defaultArea) {
  var cmbProvince = document.getElementsByName('cmbProvince')[0];
  var cmbCity = document.getElementsByName('cmbCity')[0];
  var cmbArea = document.getElementsByName('cmbArea')[0];
