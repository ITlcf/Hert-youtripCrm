  ...
  <div>
    <div id='maxdiv'>
      <el-form :inline="true" :model="formInline" class="demo-form-inline">
        <el-form-item label="国家" prop="c_countryname">
        ...
        <el-form-item label="状态" prop="vp_place">
          <el-select v-model="formInline.place.vp_place" placeholder="请选择状态" id="queryPlace">
...
//        console.log(_this.currentPageData[i].id==mulp[i].id)  // 当前页的所有数据
    ...
    created(){
      this.axios.get("/api/customCase.do").then((data)=>{
